const a = document.getElementById('inputValue'), b = document.getElementById('inputRadix'),
    c = document.getElementById('outputBinary'), d = document.getElementById('outputOctal'),
    e = document.getElementById('outputDecimal'), f = document.getElementById('outputHexadecimal'),
    g = document.getElementById('errorMessage');
