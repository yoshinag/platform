...
async function generateMD5Hash() {
    try {
        ...
        // Use SubtleCrypto API to generate MD5 hash
        // Note: Modern browsers may not support MD5 in SubtleCrypto due to security concerns
        // So we'll use a pure JavaScript implementation
        ...
        // Convert input to string and generate MD5 hash
